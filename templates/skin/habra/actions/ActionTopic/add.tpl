...
<br />
    ...
    <p class="l-bot">     
     ...
     <input type="submit" name="submit_preview" value="{$aLang.topic_create_submit_preview}" onclick="ajaxTextPreview(document.getElementById('topic_text').value,false); return false;">&nbsp;
    </p>
