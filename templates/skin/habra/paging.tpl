{if $aPaging and $aPaging.iCountPage>1} 
					<div class="prev_next">    					
    					...
    					{if $aPaging.iPrevPage}
    						<a href="{$aPaging.sBaseUrl}/page{$aPaging.iPrevPage}/" class="prev_next">сюда</a>
    					{else}
    						сюда
    					{/if}
    					&nbsp;&nbsp;
    					{if $aPaging.iNextPage}
    						<a href="{$aPaging.sBaseUrl}/page{$aPaging.iNextPage}/" class="prev_next">туда</a>
    					{else}
    						туда
    					{/if}    					
    					&nbsp;&#8594;    				
					...
					<div class="pages">
						{if $aPaging.iCurrentPage>1}
							<a class="nextprev" href="{$aPaging.sBaseUrl}/">&larr;</a>
						{/if}
						...
						{if $aPaging.iCurrentPage<$aPaging.iCountPage}
							<a class="nextprev" href="{$aPaging.sBaseUrl}/page{$aPaging.iCountPage}/">&rarr;</a>
						{/if}
					</div>
{/if}