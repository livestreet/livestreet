...
<div class="userfield-form" id="userfield_form">
	...
	<input type="button" value="{$aLang.user_field_cancel}" class="jqmClose" return false;" />
</div>

 
<a href="javascript:userfieldShowAddForm()" class="userfield-add" id="userfield_form_show">{$aLang.user_field_add}</a>
<br /><br />
