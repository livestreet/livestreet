	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		{if !$oConfig->GetValue('view.tinymce')}
			<div class="panel-form">
				...
				<a href="#" onclick="lsPanel.putTagAround('talk_text','b'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/bold_ru.gif" width="20" height="20" title="{$aLang.panel_b}" /></a>
				<a href="#" onclick="lsPanel.putTagAround('talk_text','i'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/italic_ru.gif" width="20" height="20" title="{$aLang.panel_i}" /></a>
				<a href="#" onclick="lsPanel.putTagAround('talk_text','u'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/underline_ru.gif" width="20" height="20" title="{$aLang.panel_u}" /></a>
				<a href="#" onclick="lsPanel.putTagAround('talk_text','s'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/strikethrough.gif" width="20" height="20" title="{$aLang.panel_s}" /></a>
				&nbsp;
				...
				<a href="#" onclick="lsPanel.putQuote('talk_text'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/quote.gif" width="20" height="20" title="{$aLang.panel_quote}" /></a>
				<a href="#" onclick="lsPanel.putTagAround('talk_text','code'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/code.gif" width="30" height="20" title="{$aLang.panel_code}" /></a>
				<a href="#" onclick="lsPanel.putTagAround('talk_text','video'); return false;"><img src="{cfg name='path.static.skin'}/images/panel/video.gif" width="20" height="20" title="{$aLang.panel_video}" /></a>
