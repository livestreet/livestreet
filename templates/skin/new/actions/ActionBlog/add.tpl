...
{/if}
			...
			<div class="profile-user">
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<input type="text" id="blog_title" name="blog_title" value="{$_aRequest.blog_title}" class="input-text" /><br />
       				<span class="form_note">{$aLang.blog_create_title_notice}</span>
					</p>

					<p><label for="blog_url">{$aLang.blog_create_url}:</label>
					<input type="text" id="blog_url" name="blog_url" value="{$_aRequest.blog_url}" class="input-text"  {if $_aRequest.blog_id}disabled{/if} /><br />
					...
					<select name="blog_type" id="blog_type" onChange="">
       				...
       				<span class="form_note">{$aLang.blog_create_type_notice}</span>
					</p>
					...
					<input type="text" id="blog_limit_rating_topic" name="blog_limit_rating_topic" value="{$_aRequest.blog_limit_rating_topic}" class="input-text" /><br />
