{include file='header.light.tpl'}
	...
	<div class="lite-center register">
		<form action="{router page='registration'}" method="POST">
			...
			<img src="{$aConfig.path.root.engine_lib}/external/kcaptcha/index.php?{$_sPhpSessionName}={$_sPhpSessionId}"  onclick="this.src='{$aConfig.path.root.web}/classes/lib/external/kcaptcha/index.php?{$_sPhpSessionName}={$_sPhpSessionId}&n='+Math.random();">
