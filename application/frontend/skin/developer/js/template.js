jQuery(document).ready(function($){
    ...
    // Инициализация ссылок для поиска топиков для добавления к тегам
    $('.adminAutoTags').on('click', function(){
        var button = $(this);
        button.addClass('loading');
        
        ls.ajax(aRouter['ajax']+"admin/auto/tags/",
            {
                sTag : button.data('tag')
            },
            function(response){
                button.removeClass('loading');
                console.log(response.sText);
            });
