...
{block 'user_list_add_item_actions'}
    {if $smarty.local.editable|default:true}
        <li class="ls-icon-minus js-message-users-user-inactivate" title="{$aLang.common.remove}" data-user-id="{$userId}"></li>
        <li class="ls-icon-plus js-message-users-user-activate" title="{$aLang.common.add}" data-user-id="{$userId}" data-user-login="{$user->getLogin()}"></li>
    {/if}
{/block}