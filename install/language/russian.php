...
return array(
	...
	'end_paragraph' => 'Примите поздравления! LiveStreet успешно установлена.<br />Удалите директорию Install.<br /><br />Вы можете продолжить настройку в расширенном режиме.<br /><br /><a href="../">Перейти на главную страницу</a><br /><br />',
	...
	'finish_paragraph' => 'Примите поздравления! LiveStreet успешно установлена.<br />Удалите директорию Install.<br /><br /><a href="../">Перейти на главную страницу</a>',
);